...
export async function GET(request) {
  ...
  try {
    ...
    results.quoteLink = `https://crm.shinyjets.com/q/${quote.share_link}`;
    ...
    try {
      const session = await stripe.checkout.sessions.create({
        ...
        success_url: `https://crm.shinyjets.com/q/${quote.share_link}?payment=success`,
        cancel_url: `https://crm.shinyjets.com/q/${quote.share_link}?payment=cancelled`,
        metadata: {
          quote_id: quote.id,
