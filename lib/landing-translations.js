const translations = {
  en: {
    ...
    problems: [
      { title: 'Stop Wasting Hours on Quotes', desc: 'No more spreadsheets, calculators, or back-of-napkin math. Shiny Jets CRM automates the entire process.' },
      ...
      { title: 'Your Rate \u00D7 Your Hours', desc: 'Set your hourly rate. Pick the aircraft. Adjust the hours if you want. Shiny Jets CRM handles the math \u2014 you control the numbers.' },
    ],
    ...
    steps: [
      ...
      { title: 'Select Aircraft, Build Quote', desc: 'Choose from 208 pre-loaded aircraft or add your own hours. Shiny Jets CRM calculates the price \u2014 you stay in control.' },
    ...
    pricing: {
      ...
      tiers: [
        { name: 'Free', desc: 'Try Shiny Jets CRM risk-free', cta: 'Start Free', features: ['3 quotes/month', '208 aircraft database', 'Email quotes', 'Stripe payments', '5% platform fee'] },
        { name: 'Pro', desc: 'For full-time detailers', cta: 'Go Pro', features: ['Unlimited quotes', '208 aircraft database', 'Email quotes', 'Email notifications', 'Remove Shiny Jets branding', 'Calendar & scheduling', 'Priority support', '2% platform fee'] },
    ...
    faqs: {
      ...
      items: [
        { q: 'How does pricing work?', a: 'Shiny Jets CRM multiplies your hourly rate by the service hours for each aircraft. We pre-load default hours for 208 models, but you can upload your own or adjust hours on any quote.' },
    ...
    footerCta: {
      ...
      sub: 'Shiny Jets CRM is in beta. Join now and lock in Pro pricing forever as a founding member. Built by a professional aircraft detailer with 15+ years of experience in the industry.',
      cta: 'Join as a Founding Member',
    },
    footer: {
      by: 'by Shiny Jets',
  ...
  es: {
    ...
    problems: [
      { title: 'Deja de Perder Horas en Cotizaciones', desc: 'No m\u00E1s hojas de c\u00E1lculo ni calculadoras. Shiny Jets CRM automatiza todo el proceso.' },
      ...
      { title: 'Tu Tarifa \u00D7 Tus Horas', desc: 'Establece tu tarifa por hora. Elige la aeronave. Ajusta las horas. Shiny Jets CRM hace el c\u00E1lculo.' },
    ],
    ...
    steps: [
      ...
      { title: 'Selecciona Aeronave, Crea Cotizaci\u00F3n', desc: 'Elige entre 208 aeronaves precargadas o agrega tus propias horas. Shiny Jets CRM calcula el precio.' },
    ...
    pricing: {
      ...
      tiers: [
        { name: 'Gratis', desc: 'Prueba Shiny Jets CRM sin riesgo', cta: 'Empezar Gratis', features: ['3 cotizaciones/mes', 'Base de datos de 208 aeronaves', 'Cotizaciones por email', 'Pagos con Stripe', '5% comisi\u00F3n'] },
        { name: 'Pro', desc: 'Para detalladores a tiempo completo', cta: 'Ir a Pro', features: ['Cotizaciones ilimitadas', 'Base de datos de 208 aeronaves', 'Email cotizaciones', 'Notificaciones por email', 'Sin marca Shiny Jets', 'Calendario', 'Soporte prioritario', '2% comisi\u00F3n'] },
    ...
    testimonials: {
      ...
      items: [
        { quote: 'Shiny Jets CRM me ahorra 10 horas a la semana en cotizaciones. Antes pasaba 30 minutos por cotizaci\u00F3n \u2014 ahora toma 60 segundos.', name: 'Detallador de Aeronaves', location: 'Scottsdale, AZ' },
    ...
    faqs: {
      ...
      items: [
        { q: '\u00BFC\u00F3mo funciona el precio?', a: 'Shiny Jets CRM multiplica tu tarifa por hora por las horas de servicio de cada aeronave. Precargamos horas para 208 modelos.' },
    ...
    footerCta: {
      ...
      sub: '\u00DAnete a profesionales que ahorran horas cada semana con Shiny Jets CRM. Comienza gratis.',
      cta: 'Prueba Gratis',
    },
  ...
  pt: {
    ...
    problems: [
      { title: 'Pare de Perder Horas em Or\u00E7amentos', desc: 'Sem mais planilhas ou calculadoras. O Shiny Jets CRM automatiza todo o processo.' },
      { title: '208 Aeronaves, Suas Horas', desc: 'Horas padr\u00E3o para 208 aeronaves. Use as nossas, envie as suas ou ajuste por trabalho.' },
      { title: 'Sua Taxa \u00D7 Suas Horas', desc: 'Defina sua taxa hor\u00E1ria. Escolha a aeronave. Ajuste as horas. O Shiny Jets CRM faz a conta.' },
    ],
    ...
    steps: [
      ...
      { title: 'Selecione Aeronave, Crie Or\u00E7amento', desc: 'Escolha entre 208 aeronaves pr\u00E9-carregadas. O Shiny Jets CRM calcula o pre\u00E7o.' },
    ...
    pricing: {
      ...
      tiers: [
        ...
        { name: 'Pro', desc: 'Para detalhadores em tempo integral', cta: 'Ir para Pro', features: ['Or\u00E7amentos ilimitados', 'Banco de 208 aeronaves', 'Email or\u00E7amentos', 'Notifica\u00E7\u00F5es por email', 'Sem marca Shiny Jets', 'Calend\u00E1rio', 'Suporte priorit\u00E1rio', '2% taxa'] },
    ...
    testimonials: {
      ...
      items: [
        { quote: 'O Shiny Jets CRM me economiza 10 horas por semana em or\u00E7amentos. Antes eu gastava 30 minutos por or\u00E7amento.', name: 'Detalhador de Aeronaves', location: 'Scottsdale, AZ' },
    ...
    faqs: {
      ...
      items: [
        { q: 'Como funciona o pre\u00E7o?', a: 'O Shiny Jets CRM multiplica sua taxa hor\u00E1ria pelas horas de servi\u00E7o de cada aeronave.' },
    ...
    footerCta: {
      ...
      sub: 'Junte-se aos profissionais que economizam horas toda semana com o Shiny Jets CRM.',
      cta: 'Teste Gr\u00E1tis',
    },
  ...
  fr: {
    ...
    problems: [
      { title: 'Arr\u00EAtez de Perdre des Heures', desc: 'Plus de tableurs ni de calculatrices. Shiny Jets CRM automatise tout le processus.' },
      ...
      { title: 'Votre Tarif \u00D7 Vos Heures', desc: 'D\u00E9finissez votre tarif horaire. Choisissez l\'a\u00E9ronef. Ajustez les heures. Shiny Jets CRM fait le calcul.' },
    ],
    ...
    steps: [
      ...
      { title: 'S\u00E9lectionnez l\'A\u00E9ronef, Cr\u00E9ez le Devis', desc: 'Choisissez parmi 208 a\u00E9ronefs pr\u00E9charg\u00E9s. Shiny Jets CRM calcule le prix.' },
    ...
    pricing: {
      ...
      tiers: [
        { name: 'Gratuit', desc: 'Essayez Shiny Jets CRM sans risque', cta: 'Commencer', features: ['3 devis/mois', 'Base de 208 a\u00E9ronefs', 'Devis par email', 'Paiements Stripe', '5% commission'] },
        { name: 'Pro', desc: 'Pour les d\u00E9tailleurs \u00E0 plein temps', cta: 'Passer Pro', features: ['Devis illimit\u00E9s', 'Base de 208 a\u00E9ronefs', 'Devis par email', 'Notifications par email', 'Sans marque Shiny Jets', 'Calendrier', 'Support prioritaire', '2% commission'] },
    ...
    testimonials: {
      ...
      items: [
        { quote: 'Shiny Jets CRM m\'\u00E9conomise 10 heures par semaine. Avant, je passais 30 minutes par devis \u2014 maintenant \u00E7a prend 60 secondes.', name: 'D\u00E9tailleur d\'A\u00E9ronefs', location: 'Scottsdale, AZ' },
    ...
    faqs: {
      ...
      items: [
        { q: 'Comment fonctionnent les tarifs ?', a: 'Shiny Jets CRM multiplie votre tarif horaire par les heures de service pour chaque a\u00E9ronef.' },
    ...
    footerCta: {
      ...
      sub: 'Rejoignez les professionnels qui gagnent du temps chaque semaine avec Shiny Jets CRM.',
      cta: 'Essai Gratuit',
    },
  ...
  de: {
    ...
    problems: [
      { title: 'Keine Stunden Mehr f\u00FCr Angebote', desc: 'Keine Tabellenkalkulationen oder Taschenrechner mehr. Shiny Jets CRM automatisiert den gesamten Prozess.' },
      ...
      { title: 'Ihr Satz \u00D7 Ihre Stunden', desc: 'Legen Sie Ihren Stundensatz fest. W\u00E4hlen Sie das Flugzeug. Shiny Jets CRM rechnet \u2014 Sie kontrollieren.' },
    ],
    ...
    steps: [
      ...
      { title: 'Flugzeug W\u00E4hlen, Angebot Erstellen', desc: 'W\u00E4hlen Sie aus 208 vorgeladenen Flugzeugen. Shiny Jets CRM berechnet den Preis.' },
    ...
    pricing: {
      ...
      tiers: [
        { name: 'Kostenlos', desc: 'Shiny Jets CRM risikofrei testen', cta: 'Kostenlos Starten', features: ['3 Angebote/Monat', '208 Flugzeug-Datenbank', 'E-Mail-Angebote', 'Stripe-Zahlungen', '5% Plattformgeb\u00FChr'] },
        { name: 'Pro', desc: 'F\u00FCr Vollzeit-Detailer', cta: 'Pro W\u00E4hlen', features: ['Unbegrenzte Angebote', '208 Flugzeug-Datenbank', 'E-Mail-Angebote', 'E-Mail-Benachrichtigungen', 'Ohne Shiny Jets-Branding', 'Kalender', 'Priorit\u00E4ts-Support', '2% Plattformgeb\u00FChr'] },
    ...
    testimonials: {
      ...
      items: [
        { quote: 'Shiny Jets CRM spart mir 10 Stunden pro Woche bei Angeboten. Fr\u00FCher habe ich 30 Minuten pro Angebot gebraucht.', name: 'Flugzeug-Detailer', location: 'Scottsdale, AZ' },
    ...
    faqs: {
      ...
      items: [
        { q: 'Wie funktioniert die Preisgestaltung?', a: 'Shiny Jets CRM multipliziert Ihren Stundensatz mit den Servicestunden f\u00FCr jedes Flugzeug.' },
    ...
    footerCta: {
      ...
      sub: 'Schlie\u00DFen Sie sich Profis an, die jede Woche Stunden sparen mit Shiny Jets CRM.',
      cta: 'Kostenlos Testen',
    },
  ...
  it: {
    ...
    problems: [
      { title: 'Basta Sprecare Ore nei Preventivi', desc: 'Niente pi\u00F9 fogli di calcolo o calcolatrici. Shiny Jets CRM automatizza tutto.' },
      { title: '208 Aeromobili, Le Tue Ore', desc: 'Ore predefinite per 208 aeromobili. Usa le nostre, carica le tue o regola per lavoro.' },
      { title: 'La Tua Tariffa \u00D7 Le Tue Ore', desc: 'Imposta la tua tariffa oraria. Scegli l\'aeromobile. Shiny Jets CRM fa il calcolo.' },
    ],
    ...
    steps: [
      ...
      { title: 'Seleziona Aeromobile, Crea Preventivo', desc: 'Scegli tra 208 aeromobili precaricati. Shiny Jets CRM calcola il prezzo.' },
    ...
    pricing: {
      ...
      tiers: [
        { name: 'Gratuito', desc: 'Prova Shiny Jets CRM senza rischi', cta: 'Inizia Gratis', features: ['3 preventivi/mese', 'Database 208 aeromobili', 'Preventivi email', 'Pagamenti Stripe', '5% commissione'] },
        { name: 'Pro', desc: 'Per detailer a tempo pieno', cta: 'Vai Pro', features: ['Preventivi illimitati', 'Database 208 aeromobili', 'Email preventivi', 'Notifiche email', 'Senza marchio Shiny Jets', 'Calendario', 'Supporto prioritario', '2% commissione'] },
    ...
    testimonials: {
      ...
      items: [
        { quote: 'Shiny Jets CRM mi fa risparmiare 10 ore a settimana. Prima spendevo 30 minuti per preventivo.', name: 'Detailer Aeronautico', location: 'Scottsdale, AZ' },
    ...
    faqs: {
      ...
      items: [
        { q: 'Come funzionano i prezzi?', a: 'Shiny Jets CRM moltiplica la tua tariffa oraria per le ore di servizio per ogni aeromobile.' },
    ...
    footerCta: {
      ...
      sub: 'Unisciti ai professionisti che risparmiano ore ogni settimana con Shiny Jets CRM.',
      cta: 'Prova Gratuita',
    },
  ...
  nl: {
    ...
    problems: [
      { title: 'Stop Met Uren Verspillen', desc: 'Geen spreadsheets of rekenmachines meer. Shiny Jets CRM automatiseert het hele proces.' },
      ...
      { title: 'Jouw Tarief \u00D7 Jouw Uren', desc: 'Stel je uurtarief in. Kies het vliegtuig. Shiny Jets CRM berekent \u2014 jij bepaalt.' },
    ],
    ...
    steps: [
      ...
      { title: 'Selecteer Vliegtuig, Maak Offerte', desc: 'Kies uit 208 voorgeladen vliegtuigen. Shiny Jets CRM berekent de prijs.' },
    ...
    pricing: {
      ...
      tiers: [
        { name: 'Gratis', desc: 'Probeer Shiny Jets CRM risicovrij', cta: 'Gratis Starten', features: ['3 offertes/maand', '208 vliegtuig database', 'E-mail offertes', 'Stripe betalingen', '5% platformkosten'] },
        { name: 'Pro', desc: 'Voor fulltime detailers', cta: 'Ga Pro', features: ['Onbeperkte offertes', '208 vliegtuig database', 'E-mail offertes', 'E-mail meldingen', 'Zonder Shiny Jets branding', 'Kalender', 'Prioriteit support', '2% platformkosten'] },
    ...
    testimonials: {
      ...
      items: [
        { quote: 'Shiny Jets CRM bespaart me 10 uur per week. Vroeger besteedde ik 30 minuten per offerte.', name: 'Vliegtuig-Detailer', location: 'Scottsdale, AZ' },
    ...
    faqs: {
      ...
      items: [
        { q: 'Hoe werken de prijzen?', a: 'Shiny Jets CRM vermenigvuldigt je uurtarief met de service-uren voor elk vliegtuig.' },
    ...
    footerCta: {
      ...
      sub: 'Sluit je aan bij professionals die elke week uren besparen met Shiny Jets CRM.',
      cta: 'Gratis Proberen',
    },
  ...
  ja: {
    ...
    problems: [
      { title: '\u898B\u7A4D\u306B\u4F55\u6642\u9593\u3082\u304B\u3051\u306A\u3044', desc: '\u30B9\u30D7\u30EC\u30C3\u30C9\u30B7\u30FC\u30C8\u3084\u96FB\u5353\u306F\u3082\u3046\u4E0D\u8981\u3002Shiny Jets CRM\u304C\u5168\u30D7\u30ED\u30BB\u30B9\u3092\u81EA\u52D5\u5316\u3002' },
      { title: '300\u6A5F\u4EE5\u4E0A\u3001\u3042\u306A\u305F\u306E\u6642\u9593', desc: '300\u6A5F\u4EE5\u4E0A\u306E\u30C7\u30D5\u30A9\u30EB\u30C8\u6642\u9593\u3002\u79C1\u305F\u3061\u306E\u3082\u306E\u3092\u4F7F\u3046\u304B\u3001\u81EA\u5206\u306E\u3082\u306E\u3092\u30A2\u30C3\u30D7\u30ED\u30FC\u30C9\u3002' },
      { title: '\u3042\u306A\u305F\u306E\u6599\u91D1 \u00D7 \u3042\u306A\u305F\u306E\u6642\u9593', desc: '\u6642\u7D66\u3092\u8A2D\u5B9A\u3002\u6A5F\u4F53\u3092\u9078\u629E\u3002\u6642\u9593\u3092\u8ABF\u6574\u3002Shiny Jets CRM\u304C\u8A08\u7B97\u3057\u307E\u3059\u3002' },
    ],
    howItWorks: { title: '\u4F7F\u3044\u65B9', sub: '\u30BB\u30C3\u30C8\u30A2\u30C3\u30D7\u304B\u3089\u5165\u91D1\u307E\u3067\u20143\u3064\u306E\u7C21\u5358\u306A\u30B9\u30C6\u30C3\u30D7\u3002' },
    steps: [
      { title: '\u30B5\u30FC\u30D3\u30B9\u3068\u6599\u91D1\u3092\u8FFD\u52A0', desc: '\u30B5\u30FC\u30D3\u30B9\u30E1\u30CB\u30E5\u30FC\u3068\u6642\u7D66\u3092\u8A2D\u5B9A\u3002' },
      { title: '\u6A5F\u4F53\u3092\u9078\u629E\u3001\u898B\u7A4D\u4F5C\u6210', desc: '300\u6A5F\u4EE5\u4E0A\u304B\u3089\u9078\u629E\u3002Shiny Jets CRM\u304C\u4FA1\u683C\u3092\u8A08\u7B97\u3002' },
    ...
    pricing: {
      ...
      tiers: [
        { name: '\u7121\u6599', desc: 'Shiny Jets CRM\u3092\u30EA\u30B9\u30AF\u306A\u3057\u3067\u8A66\u3059', cta: '\u7121\u6599\u3067\u59CB\u3081\u308B', features: ['3\u898B\u7A4D/\u6708', '300\u6A5F\u4EE5\u4E0A\u306EDB', '\u30E1\u30FC\u30EB\u898B\u7A4D', 'Stripe\u6C7A\u6E08', '5%\u30D7\u30E9\u30C3\u30C8\u30D5\u30A9\u30FC\u30E0\u6599'] },
        { name: 'Pro', desc: '\u30D5\u30EB\u30BF\u30A4\u30E0\u30C7\u30A3\u30C6\u30FC\u30E9\u30FC\u5411\u3051', cta: 'Pro\u306B\u3059\u308B', features: ['\u7121\u5236\u9650\u898B\u7A4D', '300\u6A5F\u4EE5\u4E0A\u306EDB', '\u30E1\u30FC\u30EB\u898B\u7A4D', '\u30E1\u30FC\u30EB\u901A\u77E5', 'Shiny Jets CRM\u30D6\u30E9\u30F3\u30C9\u524A\u9664', '\u30AB\u30EC\u30F3\u30C0\u30FC', '\u512A\u5148\u30B5\u30DD\u30FC\u30C8', '2%\u30D7\u30E9\u30C3\u30C8\u30D5\u30A9\u30FC\u30E0\u6599'] },
    ...
    testimonials: {
      title: '\u30C7\u30A3\u30C6\u30FC\u30E9\u30FC\u306E\u58F0',
      items: [
        { quote: 'Shiny Jets CRM\u306E\u304A\u304B\u3052\u3067\u898B\u7A4D\u306B\u304B\u304B\u308B\u6642\u9593\u304C\u9031\u306B10\u6642\u9593\u7BC0\u7D04\u3067\u304D\u307E\u3057\u305F\u3002', name: '\u822A\u7A7A\u6A5F\u30C7\u30A3\u30C6\u30FC\u30E9\u30FC', location: 'Scottsdale, AZ' },
    ...
    faqs: {
      title: '\u3088\u304F\u3042\u308B\u8CEA\u554F',
      items: [
        { q: '\u6599\u91D1\u306E\u4ED5\u7D44\u307F\u306F\uFF1F', a: 'Shiny Jets CRM\u306F\u6642\u7D66\u306B\u5404\u6A5F\u4F53\u306E\u30B5\u30FC\u30D3\u30B9\u6642\u9593\u3092\u639B\u3051\u3066\u8A08\u7B97\u3057\u307E\u3059\u3002' },
    ...
    footerCta: {
      ...
      sub: 'Shiny Jets CRM\u3067\u6BCE\u9031\u4F55\u6642\u9593\u3082\u7BC0\u7D04\u3057\u3066\u3044\u308B\u30D7\u30ED\u306B\u53C2\u52A0\u3057\u307E\u3057\u3087\u3046\u3002',
      cta: '\u7121\u6599\u30C8\u30E9\u30A4\u30A2\u30EB',
    },
  ...
  zh: {
    ...
    problems: [
      { title: '\u505C\u6B62\u6D6A\u8D39\u65F6\u95F4', desc: '\u4E0D\u518D\u9700\u8981\u7535\u5B50\u8868\u683C\u6216\u8BA1\u7B97\u5668\u3002Shiny Jets CRM\u81EA\u52A8\u5316\u6574\u4E2A\u6D41\u7A0B\u3002' },
      { title: '208\u98DE\u673A\uFF0C\u60A8\u7684\u65F6\u95F4', desc: '208\u98DE\u673A\u7684\u9ED8\u8BA4\u5DE5\u65F6\u3002\u4F7F\u7528\u6211\u4EEC\u7684\u6570\u636E\u3001\u4E0A\u4F20\u60A8\u7684\u6570\u636E\u6216\u6309\u5DE5\u4F5C\u8C03\u6574\u3002' },
      { title: '\u60A8\u7684\u8D39\u7387 \u00D7 \u60A8\u7684\u5DE5\u65F6', desc: '\u8BBE\u7F6E\u5C0F\u65F6\u8D39\u7387\u3002\u9009\u62E9\u98DE\u673A\u3002\u8C03\u6574\u5DE5\u65F6\u3002Shiny Jets CRM\u8BA1\u7B97\u4E00\u5207\u3002' },
    ],
    howItWorks: { title: '\u5982\u4F55\u8FD0\u4F5C', sub: '\u4ECE\u8BBE\u7F6E\u5230\u6536\u6B3E\u2014\u2014\u4E09\u4E2A\u7B80\u5355\u6B65\u9AA4\u3002' },
    steps: [
      { title: '\u6DFB\u52A0\u670D\u52A1\u548C\u8D39\u7387', desc: '\u8BBE\u7F6E\u670D\u52A1\u83DC\u5355\u548C\u5C0F\u65F6\u8D39\u7387\u3002' },
      { title: '\u9009\u62E9\u98DE\u673A\uFF0C\u521B\u5EFA\u62A5\u4EF7', desc: '\u4ECE208\u9884\u52A0\u8F7D\u98DE\u673A\u4E2D\u9009\u62E9\u3002Shiny Jets CRM\u8BA1\u7B97\u4EF7\u683C\u3002' },
    ...
    pricing: {
      ...
      tiers: [
        { name: '\u514D\u8D39', desc: '\u65E0\u98CE\u9669\u8BD5\u7528Shiny Jets CRM', cta: '\u514D\u8D39\u5F00\u59CB', features: ['3\u4E2A\u62A5\u4EF7/\u6708', '208\u98DE\u673A\u6570\u636E\u5E93', '\u90AE\u4EF6\u62A5\u4EF7', 'Stripe\u652F\u4ED8', '5%\u5E73\u53F0\u8D39'] },
        { name: 'Pro', desc: '\u9002\u5408\u5168\u804C\u7F8E\u5BB9\u5E08', cta: '\u5347\u7EA7Pro', features: ['\u65E0\u9650\u62A5\u4EF7', '208\u98DE\u673A\u6570\u636E\u5E93', '\u90AE\u4EF6\u62A5\u4EF7', '\u90AE\u4EF6\u901A\u77E5', '\u53BB\u9664Shiny Jets CRM\u54C1\u724C', '\u65E5\u5386', '\u4F18\u5148\u652F\u6301', '2%\u5E73\u53F0\u8D39'] },
    ...
    testimonials: {
      title: '\u7F8E\u5BB9\u5E08\u7684\u8BC4\u4EF7',
      items: [
        { quote: 'Shiny Jets CRM\u6BCF\u5468\u4E3A\u6211\u8282\u7701\u4E8610\u5C0F\u65F6\u7684\u62A5\u4EF7\u65F6\u95F4\u3002\u4EE5\u524D\u6BCF\u4E2A\u62A5\u4EF7\u8981\u82B130\u5206\u949F\u3002', name: '\u98DE\u673A\u7F8E\u5BB9\u5E08', location: 'Scottsdale, AZ' },
    ...
    faqs: {
      title: '\u5E38\u89C1\u95EE\u9898',
      items: [
        { q: '\u4EF7\u683C\u5982\u4F55\u8FD0\u4F5C\uFF1F', a: 'Shiny Jets CRM\u5C06\u60A8\u7684\u5C0F\u65F6\u8D39\u7387\u4E58\u4EE5\u6BCF\u67B6\u98DE\u673A\u7684\u670D\u52A1\u5DE5\u65F6\u3002' },
    ...
    footerCta: {
      title: '\u51C6\u5907\u597D\u53D1\u5C55\u4E1A\u52A1\u4E86\u5417\uFF1F',
      sub: '\u52A0\u5165\u6BCF\u5468\u7528Shiny Jets CRM\u8282\u7701\u6570\u5C0F\u65F6\u7684\u4E13\u4E1A\u4EBA\u58EB\u3002',
      cta: '\u514D\u8D39\u8BD5\u7528',
    },
