...
export function quoteSentTemplate({ quote, detailer }) {
  const { aircraft_model, aircraft_type, total_price, share_link, client_name, services, line_items, valid_until, notes, discount_percent, addon_fees, addon_total } = quote;
  ...
  const content = `
    ...
    <div style="text-align: center; margin: 30px 0;">
      <a href="${APP_URL}/q/${share_link}" style="display: inline-block; background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); color: #ffffff; padding: 16px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px;">
        View Quote & Pay
      </a>
    </div>
