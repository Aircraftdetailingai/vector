...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f0f0ee;">
  <div style="background: linear-gradient(135deg, ${headerBg} 0%, #0a1520 100%); padding: 36px 30px; border-radius: 12px 12px 0 0; text-align: center;">
    ...
    <h1 style="color: #C9A84C; margin: 0; font-size: 18px; font-weight: 400; letter-spacing: 0.3px;">${headerText}</h1>
  </div>
...
export function quoteSentTemplate({ quote, detailer, language }) {
  ...
  const discountRowHtml = discountPct > 0 ? `
        <tr>
          <td style="padding: 6px 0; color: #C9A84C; font-size: 14px;">${L.discountLabel} (${discountPct}%)</td>
          <td style="padding: 6px 0; text-align: right; color: #C9A84C; font-size: 14px;">-${discountPct}%</td>
        </tr>` : '';
    ...
    <div style="background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%); border: 1px solid #e2e8f0; border-radius: 12px; padding: 24px; margin: 0 0 24px 0;">
      ...
      <table style="width: 100%; border-collapse: collapse;">
        ...
        <tr>
          ...
          <td style="padding: 16px 0 8px 0; border-top: 2px solid #cbd5e1; text-align: right; font-weight: 800; font-size: 28px; color: #0D1B2A;">${amount}</td>
        </tr>
      </table>
    </div>
