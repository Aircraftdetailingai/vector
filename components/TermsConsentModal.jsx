...
export default function TermsConsentModal({ isOpen, onAccept }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex items-end sm:items-center justify-center z-[60] p-0 sm:p-4">
      <div className="bg-white rounded-t-2xl sm:rounded-lg p-5 sm:p-6 w-full sm:max-w-lg overflow-y-auto max-h-[95vh] sm:max-h-[90vh]">
        <div className="text-center mb-4">
          ...
          <h2 className="text-xl font-bold text-gray-900">Updated Terms &amp; Privacy Policy</h2>
          <p className="text-sm text-gray-500 mt-1">Effective {TERMS_VERSION}</p>
        </div>
        ...
        <button
          ...
          className="w-full py-3 rounded-lg bg-gradient-to-r from-amber-500 to-amber-600 text-white font-semibold hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-opacity"
        >
