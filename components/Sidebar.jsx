    ...
    <>
      ...
      <div className="h-[72px] flex items-center px-7">
        {user?.theme_logo_url ? (
          ...
          <span className="text-v-gold text-base font-light" style={{ letterSpacing: '0.3em' }}>SHINY JETS CRM</span>
        )}
      </div>
    ...
    <>
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 h-14 bg-v-sidebar z-40 flex items-center justify-between px-4 border-b border-v-border-subtle">
        {user?.theme_logo_url ? (
          ...
          <span className="text-v-gold text-sm font-light" style={{ letterSpacing: '0.3em' }}>SHINY JETS CRM</span>
        )}
